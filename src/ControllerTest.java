...
public class ControllerTest {
    ...
    private static void testInputHandler() {
        ...
        // Parse difficulty
        assert handler.parseDifficulty("1") == Difficulty.EASY : "Should parse Easy";
        assert handler.parseDifficulty("2") == Difficulty.NORMAL : "Should parse Normal";
        assert handler.parseDifficulty("3") == Difficulty.HARD : "Should parse Hard";
    ...
    private static void testGameController() {
        ...
        boolean success = gc.initializeGame(3, GameMode.INDIVIDUAL_SIMPLE, Difficulty.NORMAL, names);
    ...
    private static void testIntegration() {
        ...
        List<String> names = Arrays.asList("Dana", "Acil", "Alice");
        gc.initializeGame(3, GameMode.INDIVIDUAL_SIMPLE, Difficulty.NORMAL, names);
        gc.startGame();
