...
public class BackendTest {
    ...
    private static void testNeighborSystem() {
        try {
            ...
            controller.initializeGame(3, GameMode.INDIVIDUAL_SIMPLE, Difficulty.NORMAL, players);
    ...
    private static void testGameInitialization() {
        try {
            ...
            boolean success = controller.initializeGame(3, GameMode.INDIVIDUAL_SIMPLE, Difficulty.NORMAL, players);
